                            ...
                            >
                                ...
                                {step === 12 && (
                                    <div className="space-y-6">
                                        ...
                                        <div className="h-40 overflow-y-auto bg-gray-50 p-4 rounded-xl border border-gray-200 text-sm text-gray-600">
                                            <p>Consinto que a COOPERATIVA DE TRABALHO DOS PROFISSIONAIS DA EDUCAÇÃO DO ESTADO DO RN (COOPEDU), aqui denominada como CONTROLADORA, inscrita no CNPJ sob n° 35.537.126-0001/84, em
